...
document.addEventListener('DOMContentLoaded', async function() {
    ...
    const ui = {
        ...
        getStatusBadge(status) {
            const badges = {
                'active': '<span class="status-badge status-active"><i data-lucide="check-circle" class="h-3 w-3 mr-1"></i>Activo</span>',
                'inactive': '<span class="status-badge status-inactive"><i data-lucide="pause-circle" class="h-3 w-3 mr-1"></i>Inactivo</span>',
                'pending': '<span class="status-badge status-pending"><i data-lucide="clock" class="h-3 w-3 mr-1"></i>Pendiente</span>',
                'expired': '<span class="status-badge status-expired"><i data-lucide="alert-circle" class="h-3 w-3 mr-1"></i>Expirado</span>'
            };
                    ...
                    <tr class="table-row group">
                        <td class="table-cell">
                            <div class="flex items-center">
                                ...
                                <div>
                                    <div class="font-medium text-gray-900">Contrato #${contract.id}</div>
                        ...
                        <td class="table-cell text-right">
                            <div class="action-buttons opacity-0 group-hover:opacity-100">
                                <button onclick="editContract(${contract.id})" 
                                        class="action-btn action-btn-edit" title="Editar contrato">
                                    <i data-lucide="edit" class="h-4 w-4"></i>
                                </button>
                                <button onclick="deleteContract(${contract.id})" 
                                        class="action-btn action-btn-delete" title="Eliminar contrato">
