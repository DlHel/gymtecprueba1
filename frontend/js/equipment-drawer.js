...
class EquipmentDrawer {
    ...
    async loadNotes(equipmentId) {
        try {
            const response = await fetch(`http://localhost:3000/api/equipment/${equipmentId}/notes`);
    ...
    async loadTickets(equipmentId) {
        try {
            const response = await fetch(`http://localhost:3000/api/equipment/${equipmentId}/tickets`);
    ...
    async saveNote() {
        ...
        try {
            ...
            const response = await fetch(`http://localhost:3000/api/equipment/${this.currentEquipmentId}/notes`, {
                method: 'POST',
    ...
    async deleteNote(noteId) {
        ...
        try {
            ...
            const response = await fetch(`http://localhost:3000/api/equipment/notes/${noteId}`, {
                method: 'DELETE'
            });
