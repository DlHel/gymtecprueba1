...
async function runDiagnostics() {
    ...
    if (dbOk && backendOk && frontendOk) {
        ...
        if (!dbOk) {
            ...
            console.log('   2. Verifica las credenciales en backend/config.env');
            console.log('   3. Asegúrate de que el usuario root tenga permisos');
            console.log('   4. Ejecuta: backend/database/setup-mysql.js');
        }

        if (!backendOk) {
            console.log('\n🔧 SOLUCIONES PARA BACKEND:');
            console.log('   1. Ejecuta: cd backend && npm start');
